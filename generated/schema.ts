...
export class Token extends Entity {
  constructor(id: string) {
    ...
    this.set('untrackedVolumeUSD', Value.fromBigDecimal(BigDecimal.zero()))
    this.set('whitelist', Value.fromStringArray(new Array(0)))
    this.set('txCount', Value.fromBigInt(BigInt.zero()))
...
export class Pair extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        'Cannot save Pair entity with non-string ID. ' + 'Considering using .toHex() to convert the "id" to a string.'
      )
...
export class User extends Entity {
  ...
  set liquidityPositions(value: Array<string> | null) {
    if (!value) {
      ...
      this.set('liquidityPositions', Value.fromStringArray(<Array<string>>value))
    }
  }
...
export class LiquidityPositionSnapshot extends Entity {
  constructor(id: string) {
    ...
    this.set('reserve1', Value.fromBigDecimal(BigDecimal.zero()))
    this.set('reserveUSD', Value.fromBigDecimal(BigDecimal.zero()))
    this.set('liquidityTokenTotalSupply', Value.fromBigDecimal(BigDecimal.zero()))
    this.set('liquidityTokenBalance', Value.fromBigDecimal(BigDecimal.zero()))
  }
  ...
  static load(id: string): LiquidityPositionSnapshot | null {
    return changetype<LiquidityPositionSnapshot | null>(store.get('LiquidityPositionSnapshot', id))
  }
...
export class Mint extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        'Cannot save Mint entity with non-string ID. ' + 'Considering using .toHex() to convert the "id" to a string.'
      )
...
export class Burn extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        'Cannot save Burn entity with non-string ID. ' + 'Considering using .toHex() to convert the "id" to a string.'
      )
...
export class Swap extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        'Cannot save Swap entity with non-string ID. ' + 'Considering using .toHex() to convert the "id" to a string.'
      )
...
export class Bundle extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        'Cannot save Bundle entity with non-string ID. ' + 'Considering using .toHex() to convert the "id" to a string.'
      )
