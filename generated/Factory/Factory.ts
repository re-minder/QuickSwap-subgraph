...
export class Factory extends ethereum.SmartContract {
  ...
  allPairs(param0: BigInt): Address {
    let result = super.call('allPairs', 'allPairs(uint256):(address)', [ethereum.Value.fromUnsignedBigInt(param0)])

    return result[0].toAddress()
  }

  try_allPairs(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall('allPairs', 'allPairs(uint256):(address)', [ethereum.Value.fromUnsignedBigInt(param0)])
    if (result.reverted) {
  ...
  try_allPairsLength(): ethereum.CallResult<BigInt> {
    let result = super.tryCall('allPairsLength', 'allPairsLength():(uint256)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  createPair(tokenA: Address, tokenB: Address): Address {
    let result = super.call('createPair', 'createPair(address,address):(address)', [
  ...
  try_createPair(tokenA: Address, tokenB: Address): ethereum.CallResult<Address> {
    let result = super.tryCall('createPair', 'createPair(address,address):(address)', [
      ethereum.Value.fromAddress(tokenA),
      ethereum.Value.fromAddress(tokenB)
    ])
    if (result.reverted) {
  ...
  try_getPair(param0: Address, param1: Address): ethereum.CallResult<Address> {
    let result = super.tryCall('getPair', 'getPair(address,address):(address)', [
      ethereum.Value.fromAddress(param0),
      ethereum.Value.fromAddress(param1)
    ])
    if (result.reverted) {
